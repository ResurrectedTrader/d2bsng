...
def find_api_sources():
    api_dir = REPO_ROOT / "src" / "runtime" / "api"
    files = []
    for ext in ("*.h", "*.cpp"):
...
EVENTS_FILE = REPO_ROOT / "src" / "runtime" / "components" / "events" / "Events.h"
TXT_TABLES_FILE = REPO_ROOT / "src" / "runtime" / "api" / "globals" / "TxtTables.h"
...
_DRAWABLE_BASE_FILE = (
    REPO_ROOT / "src" / "runtime" / "api" / "classes" / "drawing" / "JSDrawableBase.h"
)
