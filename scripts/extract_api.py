...
def find_api_sources():
    api_dir = REPO_ROOT / "src" / "frontends" / "runtime" / "api"
    files = []
    for ext in ("*.h", "*.cpp"):
...
EVENTS_FILE = REPO_ROOT / "src" / "frontends" / "runtime" / "components" / "events" / "Events.h"
TXT_TABLES_FILE = REPO_ROOT / "src" / "frontends" / "runtime" / "api" / "globals" / "TxtTables.h"
