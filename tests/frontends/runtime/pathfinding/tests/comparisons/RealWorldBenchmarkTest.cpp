...
// Dump game data to tests/frontends/runtime/fixtures/maps/ to enable these benchmarks.
...
TEST_CASE("Real world benchmarks") {
    ...
    if (fixtureFiles.empty()) {
        ...
        MESSAGE("Dump game data to tests/frontends/runtime/fixtures/maps/ to enable real-world benchmarks");
