...
// src/backends/lod114d/asm_thunks/ that supplies the non-standard register input the
...
// Hook subsystem (`src/backends/lod114d/hooks/Intercepts.cpp`) overwrites a CALL/JMP at a
