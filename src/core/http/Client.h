...
inline constexpr size_t DEFAULT_MAX_RESPONSE_BYTES = 64ULL * 1024 * 1024;  // 64 MiB - guards a 32-bit address space
...
struct Request {
    ...
    uint32_t totalTimeoutMs = DEFAULT_TOTAL_TIMEOUT_MS;
