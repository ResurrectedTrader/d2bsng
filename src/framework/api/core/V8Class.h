...
class V8ClassBase {
   ...
   protected:
    ...
    static void Property(v8::Isolate* isolate, v8::Local<v8::ObjectTemplate> inst, const char* name, Getter getter) {
        ...
        auto* accessors = new framework::script::PropertyAccessors{.getter = getterFn, .setter = nullptr};
        inst->SetNativeDataProperty(v8_convert::ToV8(isolate, name), &framework::script::PropertyGetterTrampoline,
                                    nullptr, v8::External::New(isolate, accessors));
    }
    ...
    static void Property(v8::Isolate* isolate, v8::Local<v8::ObjectTemplate> inst, const char* name, Getter getter,
        ...
        // NOLINTNEXTLINE(cppcoreguidelines-owning-memory) - lifetime is isolate-bound, never freed
        auto* accessors = new framework::script::PropertyAccessors{.getter = getterFn, .setter = setterFn};
        inst->SetNativeDataProperty(v8_convert::ToV8(isolate, name), &framework::script::PropertyGetterTrampoline,
                                    &framework::script::PropertySetterTrampoline,
    ...
    static void Method(v8::Isolate* isolate, v8::Local<v8::ObjectTemplate> proto, const char* name, Func func) {
        ...
        proto->Set(isolate, name, v8::FunctionTemplate::New(isolate, &framework::script::MethodTrampoline, data),
                   v8::DontEnum);
    }
    ...
    static void StaticMethod(v8::Isolate* isolate, v8::Local<v8::FunctionTemplate> tpl, const char* name, Func func) {
        ...
        // NOLINTNEXTLINE(cppcoreguidelines-pro-type-reinterpret-cast) - function-pointer through External void*
        auto data = v8::External::New(isolate, reinterpret_cast<void*>(fnPtr));
        tpl->Set(isolate, name, v8::FunctionTemplate::New(isolate, &framework::script::MethodTrampoline, data),
                 v8::DontEnum);
    }
};
