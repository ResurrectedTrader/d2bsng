...
// Callback table the framework populates; the game layer invokes these from hooks, patches, and WndProc.
struct GameCallbacks {
    ...
    // Framework dispatches built-ins + JS-eval fallback via
    // framework::console::OnCommand. Fire-and-forget.
