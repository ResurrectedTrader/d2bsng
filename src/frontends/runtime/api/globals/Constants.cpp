...
void RegisterConstants(v8::Isolate* isolate, v8::Local<v8::ObjectTemplate> global) {
    ...
    /// @type {number}
    global->Set(isolate, "FILE_READ", convert::ToJS(isolate, static_cast<int32_t>(FileMode::Read)), readOnly);
    /// @description File.open() mode that creates/truncates a file for writing. Value 1.
    /// @type {number}
    global->Set(isolate, "FILE_WRITE", convert::ToJS(isolate, static_cast<int32_t>(FileMode::Write)), readOnly);
    /// @description File.open() mode that opens a file for appending at end of file. Value 2.
    /// @type {number}
    global->Set(isolate, "FILE_APPEND", convert::ToJS(isolate, static_cast<int32_t>(FileMode::Append)), readOnly);
    ...
    /// @type {number}
    profileType->Set(isolate, "singlePlayer", convert::ToJS(isolate, static_cast<int32_t>(ProfileType::SinglePlayer)),
                     readOnly);
    /// @description Closed Battle.net realm connection type. Value 2.
    /// @type {number}
    profileType->Set(isolate, "battleNet", convert::ToJS(isolate, static_cast<int32_t>(ProfileType::BattleNet)),
                     readOnly);
    /// @description Open Battle.net connection type. Value 3.
    /// @type {number}
    profileType->Set(isolate, "openBattleNet", convert::ToJS(isolate, static_cast<int32_t>(ProfileType::OpenBattleNet)),
                     readOnly);
    /// @description Host a TCP/IP game connection type. Value 4.
    /// @type {number}
    profileType->Set(isolate, "tcpIpHost", convert::ToJS(isolate, static_cast<int32_t>(ProfileType::TcpIpHost)),
                     readOnly);
    /// @description Join a TCP/IP game connection type. Value 5.
    /// @type {number}
    profileType->Set(isolate, "tcpIpJoin", convert::ToJS(isolate, static_cast<int32_t>(ProfileType::TcpIpJoin)),
                     readOnly);
    ...
    /// @type {number}
    stashTabKind->Set(isolate, "personal", convert::ToJS(isolate, static_cast<int32_t>(game::StashTabKind::Personal)),
                      readOnly);
    /// @description A tab of the account-wide shared stash, where the game or mod has one. Value 1.
    /// @type {number}
    stashTabKind->Set(isolate, "shared", convert::ToJS(isolate, static_cast<int32_t>(game::StashTabKind::Shared)),
                      readOnly);
    ...
    /// @type {number}
    stashTabType->Set(isolate, "normal", convert::ToJS(isolate, static_cast<int32_t>(game::StashTabType::Normal)),
                      readOnly);
