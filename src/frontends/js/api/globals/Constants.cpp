...
void RegisterConstants(v8::Isolate* isolate, v8::Local<v8::ObjectTemplate> global) {
    ...
    stashTabKind->Set(isolate, "shared", v8_convert::ToV8(isolate, static_cast<int32_t>(game::StashTabKind::Shared)),
                      readOnly);
    /// @description Namespace of stash-tab kind constants for getStashTabs() / getStashTabItems() and Unit.stashTab.
    /// @type {object}
    ...
    /// @description Namespace of stash-tab type constants for the `type` field of getStashTabs() entries.
    /// @type {object}
